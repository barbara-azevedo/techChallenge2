...
export interface IPostRepository {
    ...
    updatePost({ id_post, titulo, conteudo, id_autor }: IPost): Promise<IPost & IAutor | undefined>
    removePost(id : number): Promise<void>

    findAllPost(page: number, limit: number): Promise<IPost[] & IAutor | undefined>
    findOnePost(id: number): Promise<IPost & IAutor | null>;
    findSearchPost(search: string): Promise<IPost[] & IAutor | undefined>;
}